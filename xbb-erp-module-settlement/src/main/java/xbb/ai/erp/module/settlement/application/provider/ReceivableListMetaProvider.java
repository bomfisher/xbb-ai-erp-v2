...
@Component
public class ReceivableListMetaProvider implements ListMetaProvider {

    @Override
    public String businessCode() {
        return BusinessCodeEnum.RECEIVABLE.getCode();
    }
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(ReceivableFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(ReceivableFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(ReceivableFieldEnum field) {
