...
public class CustomerListMetaProvider implements ListMetaProvider {
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(CustomerFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(CustomerFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(CustomerFieldEnum field) {
