package xbb.ai.erp.module.masterdata.application.provider;
...
@Component
public class FundAccountListMetaProvider implements ListMetaProvider {

    @Override
    public String businessCode() {
        return BusinessCodeEnum.FUND_ACCOUNT.getCode();
    }
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(FundAccountFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(FundAccountFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(FundAccountFieldEnum field) {
