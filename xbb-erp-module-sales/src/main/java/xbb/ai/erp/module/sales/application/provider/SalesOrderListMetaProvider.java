...
@Component
public class SalesOrderListMetaProvider implements ListMetaProvider {
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(SalesOrderFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(SalesOrderFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(SalesOrderFieldEnum field) {
