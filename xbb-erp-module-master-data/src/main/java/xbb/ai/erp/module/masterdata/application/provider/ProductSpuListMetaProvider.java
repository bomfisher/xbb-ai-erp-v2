...
@Component
public class ProductSpuListMetaProvider implements ListMetaProvider {

    @Override
    public String businessCode() {
        return BusinessCodeEnum.PRODUCT_SPU.getCode();
    }
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(ProductSpuFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(ProductSpuFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(ProductSpuFieldEnum field) {
