...
import xbb.ai.erp.module.masterdata.application.provider.WarehouseListMetaProvider;

@Component
@RequiredArgsConstructor
public class WarehouseListSchemaProvider {
    private final WarehouseListMetaProvider listMetaProvider;
