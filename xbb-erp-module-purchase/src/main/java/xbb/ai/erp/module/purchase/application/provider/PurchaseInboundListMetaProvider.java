...
@Component
public class PurchaseInboundListMetaProvider implements ListMetaProvider {

    @Override
    public String businessCode() {
        return BusinessCodeEnum.PURCHASE_INBOUND.getCode();
    }
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(PurchaseInboundFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(PurchaseInboundFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(PurchaseInboundFieldEnum field) {
