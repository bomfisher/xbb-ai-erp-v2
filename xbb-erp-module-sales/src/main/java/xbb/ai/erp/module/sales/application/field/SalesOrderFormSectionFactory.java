...
public final class SalesOrderFormSectionFactory {
    private SalesOrderFormSectionFactory() {
    }
    ...
    public static List<FormSectionEntity> getSections(SceneTypeEnum scene) {
        ...
        return List.of(
            section("basic", "基本信息", 10, 4, false,
                List.of("main.orderNo", "main.customerId", "main.warehouseId", "main.orderDate", "main.deliveryDate")),
