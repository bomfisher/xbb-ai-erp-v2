...
public class PurchaseInboundRepositoryImpl implements PurchaseInboundRepository {
    ...
    @Override
    public void insert(PurchaseInbound purchaseInbound) {
        purchaseInboundMapper.insert(PurchaseInboundConvertor.toPO(purchaseInbound));
    }

    @Override
    public void insertBatch(List<PurchaseInbound> purchaseInboundList) {
        purchaseInboundMapper.insertBatch(purchaseInboundList.stream().map(PurchaseInboundConvertor::toPO).toList());
    }
