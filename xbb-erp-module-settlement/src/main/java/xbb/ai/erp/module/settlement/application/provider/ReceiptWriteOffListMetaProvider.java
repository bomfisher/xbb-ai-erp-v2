...
@Component
public class ReceiptWriteOffListMetaProvider implements ListMetaProvider {
    @Override
    public String businessCode() {
        return BusinessCodeEnum.RECEIPT_WRITEOFF.getCode();
    }
    ...
    public List<FieldEntity> buildHeaderMeta(ListCommonQueryDTO dto) {
        return Arrays.stream(ReceiptWriteOffFieldEnum.values())
