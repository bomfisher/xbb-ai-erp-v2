...
public class PurchaseOrderListMetaProvider implements ListMetaProvider {
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(PurchaseOrderFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    public ListMetaBundlePojo buildTopButtonMeta(ListCommonQueryDTO dto) {
        ...
        bundle.setTopButtonList(List.of(
            ...
            new ListButtonItemPojo("PURCHASE_INBOUND", "采购入库", 20, "PURCHASE_INBOUND"),
            new ListButtonItemPojo("AUDIT", "审核", 30, "AUDIT"),
            new ListButtonItemPojo("UNAUDIT", "反审核", 40, "UNAUDIT")
        ));
        return bundle;
    }
    ...
    private FilterField buildFilterField(PurchaseOrderFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(PurchaseOrderFieldEnum field) {
