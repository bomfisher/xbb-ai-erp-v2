...
public final class QueryConditionMapHelper {

    private QueryConditionMapHelper() {
    }

    public static Map<String, Object> newConditionMap() {
        return new HashMap<>();
    }

    public static Map<String, Object> putIfNotNull(Map<String, Object> conditionMap, String key, Object value) {
        if (value != null) {
    ...
    public static Map<String, Object> prepare(Map<String, Object> source) {
        Map<String, Object> conditionMap = source == null ? new HashMap<>() : new HashMap<>(source);
        conditionMap.entrySet().removeIf(entry -> entry.getValue() == null);
