...
@Component
public class WarehouseListMetaProvider implements ListMetaProvider {

    @Override
    public String businessCode() {
        return BusinessCodeEnum.WAREHOUSE.getCode();
    }
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(WarehouseFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(WarehouseFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(WarehouseFieldEnum field) {
