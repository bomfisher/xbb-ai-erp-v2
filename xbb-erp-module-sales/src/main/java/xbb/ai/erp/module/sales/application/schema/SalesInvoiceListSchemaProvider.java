...
import xbb.ai.erp.module.sales.application.provider.SalesInvoiceListMetaProvider;

@Component
@RequiredArgsConstructor
public class SalesInvoiceListSchemaProvider {
    private final SalesInvoiceListMetaProvider listMetaProvider;
