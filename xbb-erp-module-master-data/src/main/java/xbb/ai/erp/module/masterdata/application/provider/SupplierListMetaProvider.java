...
public class SupplierListMetaProvider implements ListMetaProvider {
    ...
    public Map<String, ListFilterMetaPojo> buildFilterConditionMeta(ListCommonQueryDTO dto) {
        ...
        Arrays.stream(SupplierFieldEnum.values())
            .filter(field -> field.getFilterName() != null)
    ...
    private FilterField buildFilterField(SupplierFieldEnum field) {
    ...
    private static ListFilterFieldTypeRule filterRule(SupplierFieldEnum field) {
