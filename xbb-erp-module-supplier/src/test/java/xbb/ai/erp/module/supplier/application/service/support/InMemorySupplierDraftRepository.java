...
public class InMemorySupplierDraftRepository implements SupplierDraftRepository {

    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    private final List<SupplierSaveDraftPojo> data = new ArrayList<>();

    public List<SupplierSaveDraftPojo> all() {
        return data;
    }

    public void seed(SupplierSaveDraftPojo draft) {
        data.add(copy(draft));
    }
