...
public class TemplateRenderer {
    ...
    public String renderRepositoryImpl(ModuleSpec moduleSpec) {
        ...
        return "package " + packageName + ";\n\n"
            ...
            + "        return " + variableName + "Mapper.findByCondition(conditionMap).stream().map(" + aggregateName + "Convertor::toDomain).toList();\n"
            + "    }\n\n"
            + "    @Override\n"
            + "    public Long count(Map<String, Object> conditionMap) {\n"
            + "        return " + variableName + "Mapper.count(conditionMap);\n"
            + "    }\n"
            + "}\n";
    }
    ...
    public String renderAppServiceImpl(ModuleSpec moduleSpec) {
        ...
        return "package " + packageName + ";\n\n"
            ...
            + "            return;\n"
            + "        }\n"
            + "        dto.getIdList().forEach(id -> " + variableName + "Repository.removeById(dto.getCorpid(), id));\n"
            + "    }\n\n"
