...
public final class SalesInvoiceFormSectionFactory {
    private SalesInvoiceFormSectionFactory() {
    }
    ...
    public static List<FormSectionEntity> getSections(SceneTypeEnum scene) {
        ...
        return List.of(
            section("basic", "基本信息", 10, 2, false, List.of("main.invoiceNo", "main.customerId", "main.invoiceDate", "main.dueDate", "main.paymentTerm", "main.invoiceType", "main.remark")),
            section("source", "开票来源", 20, 1, false, List.of("sourceSelection")),
            section("lines", "发票明细", 30, 2, false, List.of("lines")),
            section("amount", "金额汇总", 40, 2, false, List.of("main.untaxedAmount", "main.taxAmount", "main.amount"))
        );
    }
