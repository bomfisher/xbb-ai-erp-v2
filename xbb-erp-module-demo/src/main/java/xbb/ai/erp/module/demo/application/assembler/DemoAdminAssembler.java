...
public final class DemoAdminAssembler {
    ...
    public static Demo toDemo(DemoSaveDTO dto) {
        ...
        if (main != null) {
            ...
            demo.setDeleted(main.getDeleted());
    ...
    public static DemoSaveItemVO toSaveItemVO(Demo demo) {
        ...
        main.setDeleted(demo.getDeleted());
    ...
    public static DemoItem toDemoItem(DemoItemDTO dto, String corpid, Long dataId) {
    ...
    public static DemoItemDTO toDemoItemDTO(DemoItem item) {
